...
OFFSET_X = 40  # 왼쪽으로 이동시킴 (기존 96 또는 136보다 작게)
OFFSET_Y = 10  # 위쪽 여백을 조금만 두고 시작
...
def game_main():
    ...
    if tsugi > 0:
        cvs.create_image(OFFSET_X + GRID_W * CELL + 20, OFFSET_Y + 100, image=img_neko[tsugi], tag="INFO")
